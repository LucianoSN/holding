...
public class TransferCompanyToAnotherHoldingValidation : Contract<TransferCompanyToAnotherHoldingCommand>
{
    public TransferCompanyToAnotherHoldingValidation(string companyId, string newHoldingId, string role)
    {
